...
const Post = ({ banner, title, description }) => {
  const placeHolder = "https://cdn.vectorstock.com/i/500p/65/30/default-image-icon-missing-picture-page-vector-40546530.jpg";
    ...
    <div className="col-auto">
      <a href={banner} target="_blank" rel="noopener noreferrer" className="card-link">
        <div className="item card shadow p-3 mt-3 mb-3 bg-white rounded">
          <img onError={e => e.target.src = placeHolder} className="card-img-top img rounded" src={banner} alt="Card cap" />
